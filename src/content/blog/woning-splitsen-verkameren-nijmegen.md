...
toc:
  ...
  - { label: "Let op: vaak twee vergunningen", anchor: "twee-vergunningen" }
  - { label: "Waarom Donkers Advies", anchor: "waarom-donkers-advies" }
  - { label: "Het conceptverzoek: uw eerste stap", anchor: "conceptverzoek" }
  - { label: "Welke route past bij uw plan?", anchor: "welke-route" }
  - { label: "Nijmegen: een stad die naar binnen bouwt", anchor: "gebied" }
  - { label: "Veelvoorkomende plannen in Nijmegen", anchor: "veelvoorkomende-plannen" }
...
wordCount: 2239
relatedSlugs: ["bopa-principeverzoek-gelderland", "principeverzoek-afgewezen", "bopa-vooroverleg-berg-en-dal"]
breadcrumbLabel: "Omgevingsvergunning en conceptverzoek in gemeente Nijmegen"
ctaTitle: "Uw plan in Nijmegen laten beoordelen"
ctaDescription: "Donkers Advies beoordeelt of uw initiatief kansrijk is, voert de pand- en gebiedsanalyse uit, stelt het conceptverzoek op en begeleidt de formele procedure tot en met de vergunning. Dankzij ervaring met de beoordelingspraktijk van gemeenten weet u vroeg of splitsing of verkamering haalbaar is en welke vergunningen u werkelijk nodig heeft."
...
faq:
  - question: "Mag ik mijn woning in Nijmegen splitsen of verkameren?"
    answer: "Dat hangt af van uw pand en de omgeving. Nijmegen heeft beleidsregels voor kamerbewoning en woningsplitsing waarin onder meer met een 30-metercirkel rond het zwaartepunt van bestaande verkamerde of gesplitste panden wordt gewerkt. Ligt uw pand binnen zo'n cirkel, dan is dat een belemmering. Er gelden uitzonderingen, onder meer voor het centrumgebied en voor bepaalde bovenwoningen boven een niet-wonen functie."
  - question: "Wat is het zwaartepunt van een pand?"
    answer: "Krijgt een pand een vergunning voor verkamering of woningsplitsing, dan ligt daarmee het zwaartepunt van dat pand vast. Vanuit dat punt wordt de 30-metercirkel getrokken. Latere verbouwingen van het pand veranderen het zwaartepunt niet meer."
  - question: "Wat is de 30-metercirkel?"
    answer: "Vanuit het zwaartepunt van een legaal verkamerd of gesplitst pand wordt een cirkel getrokken. Binnen die cirkel is een nieuwe vergunning voor verkamering of splitsing in beginsel niet mogelijk. Het instrument voorkomt concentratie van kamerbewoning in één straat of buurt. De beleidsregels benoemen ook in welke gevallen de cirkel niet van toepassing is."
  - question: "Heb ik één of twee vergunningen nodig voor verkamering?"
    answer: "Dat hangt onder meer af van de WOZ-waarde van de woning. Naast de omgevingsvergunning, de ruimtelijke toets, kan een omzettingsvergunning uit de Huisvestingsverordening nodig zijn. Onder een bepaalde ondergrens wordt die omzettingsvergunning niet verleend, om betaalbare woningen voor starters beschikbaar te houden. De grensbedragen worden periodiek herzien; controleer de actuele Huisvestingsverordening voor uw situatie."
  - question: "Wat zijn de insluitingsregels?"
    answer: "Die voorkomen dat een zelfstandige woning ingesloten raakt tussen verkamerde panden. Een omzetting mag er niet toe leiden dat een naast-, onder- of bovengelegen zelfstandige woning wordt ingesloten, en er gelden grenzen aan het aantal direct aangrenzende verkamerde panden. Dit is een van de standaardtoetsen bij een aanvraag."
  - question: "Geldt er overgangsrecht voor bestaande kamerverhuur?"
    answer: "Ja. Bepalend is of in het verleden al een kamerverhuur- of omzettingsvergunning is verleend, of dat aantoonbaar sprake is van kamerverhuur die vóór 12 december 2007 is gestart. Wonen er inmiddels meer mensen dan destijds, dan wordt de aanvraag op basis van maatwerk beoordeeld. Documentatie van de historische situatie is hierbij cruciaal."
  - question: "Waar dien ik een conceptverzoek in?"
    answer: "Via het landelijke Omgevingsloket. U doorloopt de checkstappen en kiest bij de laatste stap voor een conceptverzoek in plaats van een definitieve aanvraag. U kunt daarbij ook vragen om een toets aan de welstandseisen en beeldkwaliteit, wat bij verbouwingen in de historische stad verstandig is."
  - question: "Wie beoordeelt mijn aanvraag in Nijmegen?"
    answer: "De behandeling van binnenplanse en buitenplanse omgevingsvergunningen verloopt via de Omgevingsdienst Groene Metropool (ODGM). De gemeente blijft het bevoegd gezag en neemt het besluit, maar de inhoudelijke behandeling ligt bij de omgevingsdienst."
  - question: "Hoe lang duurt een wijziging van het omgevingsplan?"
    answer: "Die kent twee fasen. Eerst maakt de gemeente een ontwerpwijzigingsbesluit met motivering, dat zes weken ter inzage gaat voor zienswijzen. Daarna neemt de gemeenteraad doorgaans binnen twaalf weken een besluit. Reken dus op een aanzienlijk langere doorlooptijd dan bij een omgevingsvergunning, waarvoor de reguliere termijn van acht weken geldt met een mogelijke verlenging van zes weken."
  - question: "Ik wil een pand kopen om te splitsen. Waar moet ik op letten?"
    answer: "Doe de analyse vóór de aankoop. Bepaal waar de zwaartepunten van omliggende verkamerde of gesplitste panden liggen, in welk gebied het pand valt, of het overgangsrecht van toepassing is en welke WOZ-grens geldt. Die factoren bepalen of splitsing of verkamering haalbaar is, en daarmee de waarde van het pand. Een koop met een ontbindende voorwaarde gekoppeld aan de uitkomst van een conceptverzoek is een verstandige constructie."
...
<h2 id="splitsing-verkamering">Woningsplitsing en kamerbewoning: het Nijmeegse stelsel</h2>
...
<h2 id="twee-vergunningen">Let op: vaak twee vergunningen</h2>
...
<h2 id="conceptverzoek">Het conceptverzoek: uw eerste stap</h2>
...
<h2 id="gebied">Nijmegen: een stad die naar binnen bouwt</h2>
...
<h2 id="veelvoorkomende-plannen">Veelvoorkomende plannen in Nijmegen</h2>
...
1. **Pand- en gebiedsanalyse.** Bij splitsing of verkamering wordt eerst uitgezocht hoe uw pand zich verhoudt tot de zwaartepunten in de omgeving, de gebiedsindeling en het overgangsrecht.
2. **Welke vergunningen zijn nodig?** De ruimtelijke en de volkshuisvestelijke route worden samen in beeld gebracht, inclusief een eventuele melding brandveilig gebruik.
...
Een negatieve reactie is niet altijd het einde. Bij splitsing en verkamering gaat het vaak om de ligging ten opzichte van bestaande zwaartepunten of om de voorzieningen in het pand, en dat is soms met een aangepast plan op te lossen. Lees <a href="/blog/principeverzoek-afgewezen/">wat u kunt doen bij een afgewezen verzoek</a>.
...
<p class="post-disclaimer">Gecontroleerd op 24 juli 2026. Beleidsregels, WOZ-grenzen, gebiedsindelingen en legestarieven wijzigen regelmatig. Raadpleeg voor uw eigen situatie altijd de actuele beleidsregels en verordeningen van de gemeente Nijmegen, of laat uw plan toetsen.</p>
