...
toc:
  - { label: "Wat is een omgevingsplanactiviteit?", anchor: "wat-is-het" }
  - { label: "Het beoordelingskader: waarom een OPA sterker staat dan u denkt", anchor: "beoordelingskader" }
  - { label: "OPA of BOPA? Het verschil dat uw hele traject bepaalt", anchor: "opa-of-bopa" }
  - { label: "De knip: ruimtelijk en technisch bouwen zijn twee losse vergunningen", anchor: "de-knip" }
  - { label: "Wanneer is een OPA aan de orde, en wanneer niet?", anchor: "wanneer-opa" }
  - { label: "Hoe verloopt de aanvraag?", anchor: "aanvraag" }
  - { label: "Termijnen en kosten", anchor: "kosten" }
...
category: "opa"
categoryLabel: "OPA"
searchTags: ["opa", "omgevingsvergunning", "omgevingswet", "noord-brabant", "de knip", "bopa", "bruidsschat"]
image: "../../assets/images/blog/opa-laptop.jpg"
imageAlt: "Tablet met de OPA-pagina van Donkers Advies, met een illustratie van een woning en de omgevingsvergunning"
...
faq:
  - question: "Wat is het verschil tussen een OPA en een BOPA?"
    answer: "\"OPA\" (omgevingsplanactiviteit) is het overkoepelende begrip; de BOPA is daarvan de buitenplanse variant. In de praktijk staat \"OPA\" meestal voor de binnenplanse variant: uw plan past binnen de regels van het omgevingsplan, maar er is een vergunning nodig. Bij een BOPA wijkt uw plan af van het plan en is een volledige ruimtelijke onderbouwing vereist. Kort gezegd: binnen de regels is het een binnenplanse OPA, erbuiten een BOPA."
  - question: "Heb ik een ruimtelijke onderbouwing nodig bij een OPA?"
    answer: "Niet als zodanig. Omdat uw plan binnen het omgevingsplan past, toetst de gemeente rechtstreeks aan de planregels en is een volledige ruimtelijke onderbouwing niet nodig. Wel kan het omgevingsplan om specifieke gegevens vragen, bijvoorbeeld een parkeerbalans, een akoestisch rapport of een onderbouwing van de beeldkwaliteit."
  - question: "Hoe lang duurt een OPA-aanvraag?"
    answer: "De gemeente beslist binnen acht weken, met een eenmalige verlenging van maximaal zes weken. De maximale doorlooptijd is dus veertien weken. Er komt geen ontwerpbesluit ter inzage, zoals bij de uitgebreide procedure van een BOPA."
  - question: "Wat kost een OPA-aanvraag?"
  ...
  - question: "Kan de gemeente een OPA weigeren?"
    answer: "Alleen op grond van de beoordelingsregels in het omgevingsplan zelf. De toets is limitatief en imperatief: voldoet uw activiteit aan de planregels, eventueel onder voorschriften, dan moet de gemeente de vergunning verlenen. Zij mag niet weigeren op algemene ruimtelijke of beleidsmatige gronden die niet in het plan staan."
  - question: "Wat is de knip bij bouwen?"
    answer: "De knip is de scheiding tussen het ruimtelijke en het technische deel van een bouwactiviteit. Het ruimtelijke deel (de omgevingsplanactiviteit) wordt getoetst aan het omgevingsplan, het technische deel aan het Besluit bouwwerken leefomgeving. Beide kunnen los van elkaar vergunningplichtig, meldingsplichtig of vergunningvrij zijn."
  - question: "Moet ik participatie organiseren bij een OPA?"
    answer: "Bij de aanvraag geeft u aan of participatie heeft plaatsgevonden. Een verplichting om daadwerkelijk te participeren geldt bij een OPA doorgaans niet; de aanwijzing van verplichte gevallen door de gemeenteraad ziet specifiek op de BOPA."
  - question: "Wat als mijn plan net niet binnen het omgevingsplan past?"
    answer: "Dan komt u in het buitenplanse spoor terecht en heeft u een BOPA nodig, met een volledige ruimtelijke onderbouwing. Soms is het mogelijk het plan zo aan te passen dat het alsnog binnen de planregels of binnen een binnenplanse afwijkmogelijkheid valt. Een principeverzoek of een korte haalbaarheidstoets maakt dat vooraf duidelijk."
---
...
<h2 id="wat-is-het">Wat is een omgevingsplanactiviteit?</h2>
...
- de buitenplanse variant, de [BOPA](/blog/wat-is-een-bopa/), waarbij uw plan van die regels afwijkt.
...
<h2 id="beoordelingskader">Het beoordelingskader: waarom een OPA sterker staat dan u denkt</h2>
...
<h2 id="opa-of-bopa">OPA of BOPA? Het verschil dat uw hele traject bepaalt</h2>
...
<tr><td>Grondslag beoordeling</td><td>Artikel 8.0a lid 1 Bkl</td><td>Artikel 8.0a lid 2 Bkl</td></tr>
<tr><td>Toetsingskader</td><td>De beoordelingsregels in het plan zelf</td><td>Evenwichtige toedeling van functies aan locaties</td></tr>
<tr><td>Karakter van de toets</td><td>Limitatief en imperatief</td><td>Beleidsruimte voor het college</td></tr>
<tr><td>Ruimtelijke onderbouwing</td><td>Niet als zodanig vereist</td><td>Volledige onderbouwing vereist</td></tr>
<tr><td>Beslistermijn</td><td>8 weken, plus 6 weken verlenging</td><td>Regulier idem; uitgebreid 6 maanden</td></tr>
<tr><td>Kostenverhaal</td><td>Zelden</td><td>Vaak, bij aangewezen bouwactiviteiten</td></tr>
<tr><td>Advies gemeenteraad</td><td>Nee</td><td>Mogelijk bindend advies (artikel 16.15a Ow)</td></tr>
<tr><td>Participatie</td><td>Melden bij de aanvraag</td><td>Melden, soms verplicht (artikel 16.55 lid 7 Ow)</td></tr>
</tbody>
</table>
</div>

De praktische betekenis: een OPA is sneller, goedkoper en voorspelbaarder. Loopt uw plan als OPA, dan bespaart u een volledige [ruimtelijke onderbouwing](/blog/ruimtelijke-onderbouwing-bopa/), de bijbehorende onderzoekskosten en een aanzienlijk deel van de doorlooptijd.

Precies daarom loont het om vóór alles uit te zoeken welke route werkelijk van toepassing is. Initiatiefnemers, en soms ook gemeenten, gaan te snel uit van een BOPA terwijl het plan binnenplans vergunbaar blijkt, of binnen een binnenplanse afwijkmogelijkheid valt die het plan al toelaat. Twijfelt u, dan geeft een [principeverzoek](/blog/principeverzoek-indienen/) vooraf duidelijkheid, en voorkomt u dat u de zware route inslaat waar de lichte volstond.
...
<h2 id="de-knip">De knip: ruimtelijk en technisch bouwen zijn twee losse vergunningen</h2>
...
<h2 id="wanneer-opa">Wanneer is een OPA aan de orde, en wanneer niet?</h2>
...
- uw activiteit is in strijd met het omgevingsplan: [dan is het een BOPA](/blog/wat-is-een-bopa/) en komt u in het [buitenplanse spoor](/buitenplanse-omgevingsplanactiviteit/) terecht
...
<h2 id="aanvraag">Hoe verloopt de aanvraag?</h2>
...
<h2 id="kosten">Termijnen en kosten</h2>
...
Dan komt u in het buitenplanse spoor terecht en heeft u een [BOPA](/buitenplanse-omgevingsplanactiviteit/) nodig, met een volledige ruimtelijke onderbouwing. Soms is het mogelijk het plan zo aan te passen dat het alsnog binnen de planregels of binnen een binnenplanse afwijkmogelijkheid valt. Een principeverzoek of een korte haalbaarheidstoets maakt dat vooraf duidelijk.
...
<p class="post-disclaimer">Wettelijke stand gecontroleerd op 24 juli 2026. Vergunningplichten, planregels en legestarieven verschillen per gemeente en wijzigen regelmatig. Laat uw eigen situatie altijd op de actuele regels toetsen.</p>
